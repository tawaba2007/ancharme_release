 ...
 */
class DeliveryDate extends \Eccube\Entity\DeliveryDate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Eccube\\Entity\\DeliveryDate' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\DeliveryDate' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\DeliveryDate' . "\0" . 'value', '' . "\0" . 'Eccube\\Entity\\DeliveryDate' . "\0" . 'rank');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DeliveryDate $proxy) {
