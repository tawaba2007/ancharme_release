...
class MailTemplate extends \Eccube\Entity\MailTemplate implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Eccube\\Entity\\MailTemplate' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\MailTemplate' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\MailTemplate' . "\0" . 'file_name', '' . "\0" . 'Eccube\\Entity\\MailTemplate' . "\0" . 'subject', '' . "\0" . 'Eccube\\Entity\\MailTemplate' . "\0" . 'header', '' . "\0" . 'Eccube\\Entity\\MailTemplate' . "\0" . 'footer', '' . "\0" . 'Eccube\\Entity\\MailTemplate' . "\0" . 'del_flg', '' . "\0" . 'Eccube\\Entity\\MailTemplate' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\MailTemplate' . "\0" . 'update_date', '' . "\0" . 'Eccube\\Entity\\MailTemplate' . "\0" . 'Creator');
        }
