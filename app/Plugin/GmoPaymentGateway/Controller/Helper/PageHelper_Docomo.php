...
use Plugin\GmoPaymentGateway\Service\client\PG_MULPAY_Client_Docomo;
use Plugin\GmoPaymentGateway\Controller\Util\PaymentUtil;

/**
 * 決済モジュール 決済画面ヘルパー：Docomo決済
 */
class PageHelper_Docomo
{
    /**
     * array of errors
     * @var array
         ...
         \Eccube\Application $app)
    {
        ...
        $objClient = new PG_MULPAY_Client_Docomo($app);
        $result = false;
