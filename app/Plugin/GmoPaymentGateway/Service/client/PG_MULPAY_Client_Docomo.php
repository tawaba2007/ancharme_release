 ...
 */
class PG_MULPAY_Client_Docomo extends PG_MULPAY_Client_Base {
    protected $app;
    protected $const;
         ...
         \Plugin\GmoPaymentGateway\Controller\DataObj\PaymentExtension $paymentExtension)
    {
        ...
        $server_url = $gmoSetting['server_url'] . 'EntryTranDocomo.idPass';
        ...
        $server_url = $gmoSetting['server_url'] . 'ExecTranDocomo.idPass';
        $sendKey = array(
            'ShopID',
            'ShopPass',
            'AccessID',
